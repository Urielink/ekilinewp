...
//mi html previo
				...
				for (i=0;i<arraySol.length;i++){
				     ...
				     uiFaw += $( '<div><li title="' + arraySol[i] + '"><i class="fas fa-' + arraySol[i] + '"></i></li></div>' ).html();
				}    
			
				for (i=0;i<arrayReg.length;i++){
				     //console.log(arrayReg[i]);         
				     uiFaw += $( '<div><li title="' + arrayReg[i] + '"><i class="far fa-' + arrayReg[i] + '"></i></li></div>' ).html();
				}    
			
				for (i=0;i<arrayBra.length;i++){
				     //console.log(arrayBra[i]);         
				     uiFaw += $( '<div><li title="' + arrayBra[i] + '"><i class="fab fa-' + arrayBra[i] + '"></i></li></div>' ).html();
				}    
...
//fin mi html previo            	
                editor.windowManager.open({
                    ...
                    title: 'Add FontAwesome icon', //editor.getLang('ekiline_tinymce.addcols'),
                    // minWidth: 420,
                    // maxWidth: 840,
                    // minHeight: 400,
                    // maxHeight: 700,
