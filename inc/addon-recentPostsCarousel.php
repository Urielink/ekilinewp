...
class WP_Widget_Recent_Posts_Exclude extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'widget_recent_entries', 'description' => __( "The most recent posts on your site in carousel format") );
        parent::__construct(false, __('Recent Posts Carousel'), $widget_ops);
