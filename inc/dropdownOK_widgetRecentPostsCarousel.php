...
class ekiline_recent_posts_carousel extends WP_Widget {
	...
	public function form($instance) {
		...
		wp_dropdown_categories(array('show_option_all' => esc_html__('Select Category', 'text_domain'), 'show_count' => true, 'selected' => absint($post_slider_cat_id), 'name' => esc_attr($this -> get_field_name('post-slider-cat')), 'id' => esc_attr($this -> get_field_id('post-slider-category')), 'class' => 'widefat'));
