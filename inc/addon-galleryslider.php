...
add_action('print_media_templates', function(){
  ...
  <script type="text/html" id="tmpl-my-custom-gallery-setting">
    ...
    <!--label class="setting">
      <span><?php _e('My setting','ekilinewp'); ?></span>
    ...
    <label class="setting">
        <span><?php _e('Bool','ekilinewp'); ?></span>
